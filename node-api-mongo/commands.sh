...
export DB_ATLAS_URI="mongodb://admin:pWwnymGCf5XEwNoK@172.24.0.2:27017/iep-program-initialization?authSource=admin&directConnection=true"
...
env
#Create a docker network for dbcontainer
